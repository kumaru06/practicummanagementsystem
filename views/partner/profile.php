...
?>
<div class="hte-settings hte-profile hte-profile-v2">
    ...
    <section class="card hte-profile-shell">
        <form method="post" enctype="multipart/form-data" class="form js-validate hte-profile-form">
            <input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>">
            <input type="hidden" name="action" value="partner_save_profile">

            <div class="hte-profile-layout">
                <aside class="hte-profile-aside" aria-label="Organization summary">
                    <div class="hte-profile-photo-stack">
                        <div class="profile-photo-frame profile-photo-frame-lg hte-profile-photo-frame">
                        ...
                        <label class="spf-photo-upload hte-profile-photo-upload">
                ...
                <div class="hte-profile-main">
                    <div class="hte-profile-form-card__head">
                        <div class="hte-profile-section-head">
                            <span class="hte-profile-section-icon" aria-hidden="true">
                    ...
                    <div class="hte-field-grid">
                        ...
                        <label class="no-floating-label hte-field hte-field--full">
