<div class="grid cards">
    ...
    <div class="card metric"><svg viewBox="0 0 24 24"><path d="M3 21V7l6-4 6 4v14H3Zm14 0V9h4v12h-4Z"/></svg><div><strong><?= (int)$stats['companies'] ?></strong><span>Industry Partners</span></div></div>
