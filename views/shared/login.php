                    ...
                    <div class="portal-view portal-view--form<?= $showFormView ? ' is-active' : '' ?>" data-portal-view="form">
                        ...
                        <?php foreach ($loginPortals as $role => $portal): ?>
                            ...
                            >
                                ...
                                <label><?= $role === 'student' ? 'Email or USN' : 'Email' ?><input required type="<?= $role === 'student' ? 'text' : 'email' ?>" name="email" autocomplete="username"></label>
...
<script src="<?= e(asset('assets/js/login-portal.js')) ?>?v=20260611-portal-spa"></script>
</body>
</html>
