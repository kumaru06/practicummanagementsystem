            ...
            ?><div class="nav-group <?= $userGroupOpen ? 'open' : '' ?>">
                <button class="nav-group-toggle" type="button">
                    ...
                    <?php if ($pendingManageUsersTotal > 0): ?>
                        <span class="nav-link-badge" aria-label="<?= (int)$pendingManageUsersTotal ?> pending requests"><?= $pendingManageUsersTotal > 99 ? '99+' : (int)$pendingManageUsersTotal ?></span>
                    <?php endif; ?>
                ...
                <div class="nav-group-items">
                    ...
                    <a class="nav-link nav-sub <?= $currentRoute === 'admin_password_reset_requests' ? 'active' : '' ?>" href="index.php?r=admin_password_reset_requests" title="Password Reset Requests"><svg viewBox="0 0 24 24"><path d="M12 2a5 5 0 0 1 5 5v3h1a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h1V7a5 5 0 0 1 5-5Zm0 2a3 3 0 0 0-3 3v3h6V7a3 3 0 0 0-3-3Zm0 9a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z"/></svg><span class="nav-link-text">Password Reset Requests</span><?php if ($pendingPasswordResetCount > 0): ?><span class="nav-link-badge" aria-label="<?= (int)$pendingPasswordResetCount ?> pending password resets"><?= $pendingPasswordResetCount > 99 ? '99+' : (int)$pendingPasswordResetCount ?></span><?php endif; ?></a>
                </div>
            </div><?php endif; ?>
