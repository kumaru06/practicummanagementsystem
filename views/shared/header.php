...
<?php
            ...
            <?php if ($role === 'partner'): ?>
                ...
                <a class="nav-link <?= $currentRoute === 'chat' ? 'active' : '' ?>" href="index.php?r=chat"><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H5.17L4 17.17V4h16v12z"/></svg><span>Live Chat</span></a>
