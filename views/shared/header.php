...
<?php
            ...
            <?php endif; ?>
            <?php if ($role === 'partner'): ?>
                <a class="nav-link <?= $currentRoute === 'partner' ? 'active' : '' ?>" href="<?= e(route_url('partner.dashboard')) ?>"><svg viewBox="0 0 24 24"><path d="M3 11h8V3H3v8Zm10 0h8V3h-8v8ZM3 21h8v-8H3v8Zm10 0h8v-8h-8v8Z"/></svg><span>Dashboard</span></a>
