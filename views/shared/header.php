...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('assets/css/style.css')) ?>?v=20260618-partners-card-hover-fix">
</head>
...
<div class="app-shell">
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <?php if ($role === 'admin'): ?><a class="nav-link <?= $currentRoute === 'admin_email_logs' ? 'active' : '' ?>" href="index.php?r=admin_email_logs"><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2Zm0 4-8 5-8-5V6l8 5 8-5v2Z"/></svg><span>Email Logs</span></a><a class="nav-link <?= $currentRoute === 'admin_evaluations' ? 'active' : '' ?>" href="index.php?r=admin_evaluations"><svg viewBox="0 0 24 24"><path d="M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17Z"/></svg><span>Evaluations</span></a><a class="nav-link <?= $currentRoute === 'admin_programs' ? 'active' : '' ?>" href="index.php?r=admin_programs"><svg viewBox="0 0 24 24"><path d="M4 5h16v14H4V5Zm2 2v10h12V7H6Zm2 2h8v2H8V9Zm0 4h6v2H8v-2Z"/></svg><span>Programs / Courses</span></a><a class="nav-link <?= $currentRoute === 'chat' ? 'active' : '' ?>" href="index.php?r=chat"><svg viewBox="0 0 24 24"><path d="M4 5h16v10H7l-3 3V5Z"/></svg><span>Live Chat</span></a><?php endif; ?>
