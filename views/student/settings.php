<div class="grid two">
    <section class="card">
        ...
        <div class="action-list" style="display:flex;gap:12px;flex-wrap:wrap">
            <a class="btn btn-primary" href="index.php?r=student_profile">Edit Profile</a>
            <a class="btn" href="index.php?r=student_password">Change Password</a>
        </div>
    </section>
    <section class="card">
