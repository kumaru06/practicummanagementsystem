<?php
    ...
    $stageDescriptions = [
        ...
        2 => 'Your endorsement letter is generated by your coordinator. Upload your recommendation letter for review.',
    ...
    <?php elseif ($currentStage): ?>
        ...
        <section class="card requirements-card docs-stage docs-stage--<?= (int)$activeStage ?><?= $accessible ? '' : ' is-locked' ?>" id="stage-<?= (int)$activeStage ?>">
            <div class="section-head section-head-split">
                <div>
                    <h2><?= $activeStage === 2 ? 'Endorsement &amp; Recommendation' : 'During &amp; Post-OJT Documents' ?></h2>
                    <p class="muted">
                        <?= $activeStage === 2
