...
<div class="grid two">
    <section class="card">
        ...
        <form method="post" enctype="multipart/form-data" class="form js-validate">
            ...
            <label><span>Email <span class="field-required">*</span></span><input required type="email" name="email" autocomplete="email" data-email-check><span class="field-check-message" data-email-message hidden aria-live="polite"></span></label>
