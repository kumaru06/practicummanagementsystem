<div class="grid cards">
    ...
    <div class="card metric" title="Assigned students without an official OJT start date (includes enrolled pre-deployment)."><svg viewBox="0 0 24 24"><path d="M12 2a5 5 0 1 0 0 10A5 5 0 0 0 12 2Zm0 12c-5.33 0-8 2.67-8 4v2h16v-2c0-1.33-2.67-4-8-4Z"/></svg><div><strong><?= (int)($stats['awaiting_start'] ?? 0) ?></strong><span>Not Yet Started</span></div></div>
</div>
